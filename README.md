...
tag publication은 네 표준 actual target의 동일한 immutable
commit+cohort와 exact catalog/plan/binary verified evidence를 통과해야 하며,
결과는 영구 asset `release-promotion.json`으로 release에 함께 포함된다.
